    ...
    <div class="container mx-auto px-3 py-0 bg-zinc-100">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-center space-x-4">
                <a href="{{ route('admin.dashboard') }}" class="bg-emerald-500 sm:mr-0 lg:mr-3 text-white px-3 py-2 rounded-2xl lg:text-lg sm:text-sm border border-emerald-700 hover:bg-emerald-700  hover:border-emerald-700 transition duration-300 focus:outline-none">Dashboard</a>
